package utils
{
    ...
    public class ProgressBar extends Sprite
    {
        ...
        private function init(width:int, height:int):void
        {
            ...
            bgShape.graphics.beginFill(0x7bc143, 0.6);
            ...
            mBar = new Quad(width - 2*padding, height - 2*padding, 0xed1066);
            mBar.setVertexColor(2, 0xf598aa);
            mBar.setVertexColor(3, 0xf598aa);
            mBar.x = padding;
            mBar.y = padding;
            mBar.scaleX = 0;
            addChild(mBar);
